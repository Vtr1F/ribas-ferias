...
function Sidebar() {
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-top">
        ...
        <nav>
          ...
          {(user.role === ROLES.ADMIN || user.role === ROLES.TEAM_LEADER) && (
            <NavLink to="/users" end className="sidebar-nav-button">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Pedidos por Equipa — só Admin e Team Leader */}
          {(user.role === ROLES.ADMIN || user.role === ROLES.TEAM_LEADER) && (
            <NavLink to="/equipas" className="sidebar-nav-button">
          ...
          {/* Perfil — todos */}
          <NavLink to="/profile" className="sidebar-nav-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
              fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* Histórico — todos */}
          <NavLink to="/historico" className="sidebar-nav-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
              fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Settings — todos */}
      <NavLink to="/settings" className="sidebar-nav-button">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
          fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
